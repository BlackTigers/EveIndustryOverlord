...
public class CharacterSettings {
	...
	private Map<InputMaterial, Integer> mReprocessingMaterialEfficiencies = new HashMap<InputMaterial, Integer>();
	...
	public double getReprocessingRate(List<Integer> pMaterials) {
		...
		double lReprocessingRate = lFacilityValue * lPlayerBonus;
		
		return lReprocessingRate;
	}
}
